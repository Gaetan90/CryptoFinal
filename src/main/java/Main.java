...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try {
            ...
            File f = new File("C:\\Users\\Gaetan\\Documents\\Fichiers\\PC.txt");
            ...
            List<String> lines = FileUtils.readLines(f, "US-ASCII");
            //List<String> dicoL = FileUtils.readLines(dico, "UTF-8");
            for (String line : lines) {
                System.out.println(c.decrypte2( line, keyS));
                resultCrypt += line;
            }
                        ...
                        for(int a4 =3;a4<26;a4++){
                            ...
                            for(int a5 =12;a5<26;a5++){
                                for(int a6 =15;a6<26;a6++){
                                    ...
                                    result = c.decrypte( resultCrypt, key);
